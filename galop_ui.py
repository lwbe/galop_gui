...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(10, 237, 1131, 391))
        self.tab = QWidget()
        ...
        self.frame.setGeometry(QRect(11, 11, 800, 219))
        self.frame.setMinimumSize(QSize(0, 0))
        self.frame.setMaximumSize(QSize(800, 300))
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.widget = QWidget(self.frame)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(12, 12, 741, 199))
        ...
        self.x_global = QLineEdit(self.widget)
        self.x_global.setObjectName(u"x_global")
        self.x_global.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.x_global, 2, 1, 1, 1)

        self.x_local = QLineEdit(self.widget)
        self.x_local.setObjectName(u"x_local")
        self.x_local.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.x_local, 2, 2, 1, 1)

        self.x_origin = QLineEdit(self.widget)
        self.x_origin.setObjectName(u"x_origin")
        self.x_origin.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.x_origin, 2, 3, 1, 1)

        self.x_m = QPushButton(self.widget)
        self.x_m.setObjectName(u"x_m")
        self.x_m.setMaximumSize(QSize(40, 16777215))

        self.gridLayout.addWidget(self.x_m, 2, 4, 1, 1)

        self.x_step = QLineEdit(self.widget)
        self.x_step.setObjectName(u"x_step")
        self.x_step.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.x_step, 2, 5, 1, 1)

        self.x_p = QPushButton(self.widget)
        self.x_p.setObjectName(u"x_p")
        self.x_p.setMaximumSize(QSize(40, 16777215))

        self.gridLayout.addWidget(self.x_p, 2, 6, 1, 1)

        self.x_acc = QLineEdit(self.widget)
        self.x_acc.setObjectName(u"x_acc")
        self.x_acc.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.x_acc, 2, 7, 1, 1)

        self.x_speed = QLineEdit(self.widget)
        self.x_speed.setObjectName(u"x_speed")
        self.x_speed.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.x_speed, 2, 8, 1, 1)
        ...
        self.y_global = QLineEdit(self.widget)
        self.y_global.setObjectName(u"y_global")
        self.y_global.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.y_global, 3, 1, 1, 1)

        self.y_local = QLineEdit(self.widget)
        self.y_local.setObjectName(u"y_local")
        self.y_local.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.y_local, 3, 2, 1, 1)

        self.y_origin = QLineEdit(self.widget)
        self.y_origin.setObjectName(u"y_origin")
        self.y_origin.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.y_origin, 3, 3, 1, 1)

        self.y_m = QPushButton(self.widget)
        self.y_m.setObjectName(u"y_m")
        self.y_m.setMaximumSize(QSize(40, 16777215))

        self.gridLayout.addWidget(self.y_m, 3, 4, 1, 1)

        self.y_step = QLineEdit(self.widget)
        self.y_step.setObjectName(u"y_step")
        self.y_step.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.y_step, 3, 5, 1, 1)

        self.y_p = QPushButton(self.widget)
        self.y_p.setObjectName(u"y_p")
        self.y_p.setMaximumSize(QSize(40, 16777215))

        self.gridLayout.addWidget(self.y_p, 3, 6, 1, 1)

        self.y_acc = QLineEdit(self.widget)
        self.y_acc.setObjectName(u"y_acc")
        self.y_acc.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.y_acc, 3, 7, 1, 1)

        self.y_speed = QLineEdit(self.widget)
        self.y_speed.setObjectName(u"y_speed")
        self.y_speed.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.y_speed, 3, 8, 1, 1)
        ...
        self.z_global = QLineEdit(self.widget)
        self.z_global.setObjectName(u"z_global")
        self.z_global.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.z_global, 4, 1, 1, 1)

        self.z_local = QLineEdit(self.widget)
        self.z_local.setObjectName(u"z_local")
        self.z_local.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.z_local, 4, 2, 1, 1)

        self.z_origin = QLineEdit(self.widget)
        self.z_origin.setObjectName(u"z_origin")
        self.z_origin.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.z_origin, 4, 3, 1, 1)

        self.z_m = QPushButton(self.widget)
        self.z_m.setObjectName(u"z_m")
        self.z_m.setMaximumSize(QSize(40, 16777215))

        self.gridLayout.addWidget(self.z_m, 4, 4, 1, 1)

        self.z_step = QLineEdit(self.widget)
        self.z_step.setObjectName(u"z_step")
        self.z_step.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.z_step, 4, 5, 1, 1)

        self.z_p = QPushButton(self.widget)
        self.z_p.setObjectName(u"z_p")
        self.z_p.setMaximumSize(QSize(40, 16777215))

        self.gridLayout.addWidget(self.z_p, 4, 6, 1, 1)

        self.z_acc = QLineEdit(self.widget)
        self.z_acc.setObjectName(u"z_acc")
        self.z_acc.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.z_acc, 4, 7, 1, 1)

        self.z_speed = QLineEdit(self.widget)
        self.z_speed.setObjectName(u"z_speed")
        self.z_speed.setMaximumSize(QSize(90, 16777215))

        self.gridLayout.addWidget(self.z_speed, 4, 8, 1, 1)

        self.horizontalSpacer = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer, 4, 9, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout.addItem(self.verticalSpacer, 5, 3, 1, 1)

        self.set_origin = QPushButton(self.widget)
        self.set_origin.setObjectName(u"set_origin")

        self.gridLayout.addWidget(self.set_origin, 6, 1, 1, 1)

        self.goto_origin = QPushButton(self.widget)
        self.goto_origin.setObjectName(u"goto_origin")

        self.gridLayout.addWidget(self.goto_origin, 6, 2, 1, 1)

        self.home = QPushButton(self.widget)
        self.home.setObjectName(u"home")

        self.gridLayout.addWidget(self.home, 6, 6, 1, 2)
